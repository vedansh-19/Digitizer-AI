...
2. **Medical Prescriptions:** Digitizes handwritten doctor prescriptions, extracting patient details, doctor information, and structured medication tables.

Additionally, the application features an integrated AI Chat Assistant that maintains context of your uploaded notes, allowing you to ask follow-up questions to understand the logic or learn more about the prescribed medications!
